"""
whatsapp_service — i18n_service.py
Multilingual Translation & Script Detection Service for WhatsApp Healthcare.
Supports 11+ Indian Regional Languages (Hindi, Bengali, Tamil, Telugu, Marathi, Gujarati, Kannada, Malayalam, Punjabi, Odia, English).
"""
...
# Multi-Language Pre-Translated Clinical Emergency, Triage, and Health Strings
CLINICAL_I18N_STRINGS = {
    "en": {
        ...
        "ecg_normal": "Sinus Rhythm: No signs of Atrial Fibrillation detected."
    },
    "hi": {
        ...
        "wearable_sync_success": "सफलतापूर्वक सिंक हुआ।",
        "ecg_normal": "साइनस रिदम: ईसीजी सेंसर द्वारा कोई असामान्यता नहीं पाई गई।"
    },
    "bn": {
        ...
        "wearable_sync_success": "সফলভাবে সিঙ্ক হয়েছে।",
        "ecg_normal": "স্বাভাবিক সাইনাস রিদম: কোনো সমস্যা সনাক্ত হয়নি।"
    },
    "ta": {
        ...
        "wearable_sync_success": "வெற்றிகரமாக ஒத்திசைக்கப்பட்டது.",
    ...
    "te": {
        ...
        "wearable_sync_success": "విజయవంతంగా సింక్ చేయబడింది.",
    ...
    "mr": {
        ...
        "abha_badge": "आयुष्मान भारत डिजिटल मिशन (ABDM) सत्यापित",
        "wearable_sync_success": "यशस्वीरित्या सिंक झाले.",
    ...
    "gu": {
        ...
        "wearable_sync_success": "સફળતાપૂર્વક સિંક થયું.",
    ...
    "kn": {
        ...
        "abha_badge": "ಆಯುಶ್ಮಾನ್ ಭಾರತ್ ಡಿಜಿಟಲ್ ಮಿಷನ್ ಪರಿಶೀಲಿಸಲಾಗಿದೆ",
        "wearable_sync_success": "ಯಶಸ್ವಿಯಾಗಿ ಸಿಂಕ್ ಆಗಿದೆ.",
    ...
    "ml": {
        ...
        "wearable_sync_success": "സമന്വയിപ്പിച്ചു.",
    ...
    "pa": {
        ...
        "wearable_sync_success": "ਸਫਲਤਾਪੂਰਵਕ ਸਿੰਕ ਹੋਇਆ।",
    ...
    "or": {
        ...
        "wearable_sync_success": "ସଫଳତାର ସହିତ ସିଙ୍କ୍ ହୋଇଛି।",
    ...
    "es": {
        ...
        "wearable_sync_success": "Sincronizado con éxito.",
        "ecg_normal": "Ritmo sinusal normal."
    }
}
...
def translate_clinical_message(key: str, lang: str = "hi") -> str:
    ...
    lang_dict = CLINICAL_I18N_STRINGS.get(lang_code, CLINICAL_I18N_STRINGS.get("hi", {}))
